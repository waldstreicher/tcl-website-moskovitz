    ...
    <footer className="bg-tcl-dark text-white">
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            <div className="mb-4">
              <span className="font-serif text-3xl font-semibold tracking-wider text-white">TCL</span>
              <p className="text-xs tracking-[0.2em] uppercase text-white/50 mt-0.5">Tumescent Cryolipolysis</p>
            </div>
        ...
        <div className="border-t border-white/10 pt-8 space-y-4">
          <p className="text-sm text-white/50 text-center">
            &copy; 2025 Tumescent Cryolipolysis. All rights reserved. Procedure developed by Dr. Martin Moskovitz, MD, FACS.
          </p>
          <p className="text-xs text-white/30 text-center max-w-3xl mx-auto leading-relaxed">
            The TCL procedure is a minimally invasive surgical treatment. Results may vary. This website is for
