      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        >
          ...
          <h2 className="font-serif text-4xl lg:text-5xl text-tcl-dark font-semibold mb-4">
            How Does TuLi Compare?
          </h2>
          <p className="text-tcl-gray text-lg max-w-2xl mx-auto leading-relaxed">
            See how TuLi stacks up against traditional liposuction and non-invasive body contouring alternatives.
          </p>
        </motion.div>
            ...
            <thead>
              <tr>
                ...
                <th className="py-5 px-6 text-center border-b border-tcl-border bg-tcl-gold">
                  <span className="text-white text-sm font-semibold tracking-wide">TuLi ✓</span>
                </th>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-10">
          {[
            ...
            {
              title: 'TuLi vs. CoolSculpting & Similar',
              points: [
