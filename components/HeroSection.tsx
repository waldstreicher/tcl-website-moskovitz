  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden bg-tcl-dark">
      ...
      <div className="absolute inset-0">
        <Image
          src="/hero-woman.jpg"
          alt="Confident women in activewear — TuLi body contouring patients"
          fill
          priority
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 py-32 lg:py-0 w-full">
        <div className="max-w-xl lg:max-w-2xl">
          ...
          >
            The TuLi procedure delivers dramatic, lasting results — in just{' '}
            <span className="text-tcl-gold font-medium">15 minutes</span>, with no anesthesia and no down time.
          </motion.p>
