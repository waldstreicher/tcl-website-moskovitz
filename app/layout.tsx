...
export const metadata: Metadata = {
  ...
  description:
    'Tullia is a breakthrough minimally invasive body contouring procedure. 15-minute treatment, no anesthesia, immediate return to activity. Invented by Dr. Martin Moskovitz, MD, FACS.',
  keywords: [
    'Tullia',
    'tumescent lipolysis',
    'body contouring',
